    ...
    return (
        <div className={styles.sidebar}>
            ...
            <div className={styles.icons}>
                ...
                <a href="https://www.instagram.com/m.ruwishka/" className={styles.iconLink} aria-label="Instagram: https://www.instagram.com/mr_ruwishka?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">
                    <Instagram size={24} />
                </a>
